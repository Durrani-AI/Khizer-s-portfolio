...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: ["PostgreSQL", "MongoDB Atlas", "Supabase"],
  },
  {
    key: "ai",
    label: "AI & ML",
    ...
    items: ["Groq API", "Ollama", "Generative AI fundamentals", "ML Fundamentals"," LangChain",],
  },
  {
    key: "devops",
    label: "DevOps & Tools",
    ...
    items: ["Git", "GitHub CI/CD", "Linux", "Render", "Vercel", "Docker"],
  },
  {
    key: "data",
    label: "Data",
